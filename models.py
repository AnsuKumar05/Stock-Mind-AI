...
class DailyStockData(db.Model):
    """Model to store current day's stock data with strict 1-day retention"""
    ...
    company = db.relationship('Company', backref=db.backref('daily_data', lazy=True, cascade='all, delete-orphan'))
